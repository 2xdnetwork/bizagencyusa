...
<html lang="en">
  <head>
    ...
    <meta property="og:url" content="https://www.bizagency-usa.com/digital/">
    ...
    <meta name="twitter:url" content="https://www.bizagency-usa.com/digital/">
    ...
    <div class="wrapper">
      <div class="header-6">
        <div class="page-header">
          <div class="page-header-image" data-bg-style="/assets/img/header-digital.jpg" data-responsive="true"></div>
          <div class="container">
            <div class="mt-3 mt-md-5 row">
              <div class="col-md-7 col-lg-6 mr-auto text-left">
                <h1 class="title text-uppercase h3 animate animate-1"><span class="h6 font-weight-normal mb-2 d-block">Services</span><span class="head-line h3 font-weight-bolder animate animate-2">Digital and Printed <span class="text-primary">Marketing</span></span></h1>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 order-1 order-md-1 pt-4 pt-md-6">
              <div class="shift-top bigger"><img data-img-src="/assets/img/digital-content-16.jpg" data-img-src-2x="" alt="" class="shadows"></div>
            </div>
            <div class="col-md-6 mt-4 mt-md-6">
              <div class="title-header">
                <h2>Digital or Printed <span class="orange">Marketing?</span></h2>
              </div>
              <p class="font-weight-bold h5">We at bizagency-usa.com believe there should be no inefficient marketing, whether digital or printed. No matter what means are used to achieve the objectives, the success of an advertising campaign depends on the strategies employed.</p>
              ...
              <p>By combining digital channels with printed ones, bizagency-usa.com offers a marketing strategy that can reach a variety of audiences and expand your visibility.</p>
            </div>
          </div>
        </div>
      </div>
      <div class="content-15 mt-5">
        <div class="container">
          <div class="row">
            <div class="col-md-5">
              <div class="title-header">
                <h2>Digital advertising <span class="orange">A business need</span></h2>
                <div class="pt-md-6 shift-top"><img data-img-src="/assets/img/digital-content-15.jpg" data-img-src-2x="" alt="" class="shadows"></div>
              </div>
            </div>
      ...
      <div class="content-16 mt-5" id="section1">
        <div class="container">
          <div class="row">
            <div class="col-md-6 order-1 order-md-1 pt-4 pt-md-6">
              <div class="shift-top bigger"><img data-img-src="/assets/img/digital-content-16-1.jpg" data-img-src-2x="" alt="" class="shadows"></div>
            </div>
            <div class="col-md-6 mt-4 mt-md-6">
              <div class="title-header">
                <h2>DIGITAL MARKETING <span class="orange">IN TRADITIONAL MARKETING.</span></h2>
              </div>
              ...
              <p>bizagency-usa.com recommends that clients do not discard printed media. To provide the best results, we analyze how to use them. The more communication channels you use, the more effective your campaign will be and the more people you will reach.</p>
