...
<html lang="en">
  <head>
    ...
    <meta property="og:url" content="https://www.bizagency-usa.com/privacy-policy.php">
    ...
    <meta name="twitter:url" content="https://www.bizagency-usa.com/privacy-policy.php">
          ...
          <div class="container">
            <div class="mt-3 mt-md-5 row">
              <div class="col-md-7 col-lg-6 mr-auto text-left">
                <h1 class="title text-uppercase h3 animate animate-1"><span class="h6 font-weight-normal mb-2 d-block"></span><span class="head-line h3 font-weight-bolder animate animate-2">Privacy <span class="text-primary">Policy</span></span></h1>
                <div class="buttons text-left animate animate-3">Updated: January 23, 2022</div>
              </div>
            </div>
          </div>
               ...
               <div class="tabs-content mt-5">
                  <div class="row">
                     <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <div class="informationmain-right-content">
                        <p>In general, you do not need to provide us with any Personal Information in order to browse the Sites.  While using our Site, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you. Personally identifiable information may include, but is not limited to your name (“Personal Information”). If you do not want to share your Personal Information with us, please do not submit it.  Unfortunately, this may mean that we will not be able to provide you with the services you have requested.</p>
                     </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="tabs-content mt-5">
                  <div class="row">
                     <div class="col-lg-12 col-md-12 col-12">
                        <h3>Cookies</h3>
                        <div class="informationmain-right-content">
                        <p>Cookies are text-only strings of information that a website transfers to the cookie file of the browser on your computer’s hard drive so the website can remember who you are.  We may use cookies to recognize you when you return to the Sites in order to provide you with a better user experience.  Most websites use cookies and cookies alone cannot be used to identify you.  A cookie will usually contain the name of the domain from which the cookie has come, the “lifetime” of the cookie, and a value (usually a randomly generated unique number).  We use two types of cookies on this website:</p>

                            <p>Session cookies – temporary cookies that remain in the cookie file of your browser until you leave the site.  Session cookies are used to carry information across pages of the Sites so you don’t have to re-enter information in order to access areas of your account such as stored files.</p>

                            <p>Persistent cookies – cookies that remain in the cookie file of your browser for much longer (though how long will depend on the lifetime of the specific cookie).  Persistent cookies are used to help us recognize you as a unique visitor when you return to our website.  They also allow us to tailor content or advertisements to match your preferred interests or to avoid showing you the same adverts repeatedly.  We also use persistent cookies to compile anonymous, aggregated statistics that allow us to understand how the Sites are used and to help us improve the structure of the Sites.</p>
               ...
               <div class="tabs-content mt-5">
                  <div class="row">
                     <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <div class="informationmain-right-content">
                        <p>This Privacy Policy is effective as of March 1, 2020 and will remain in effect except with respect to any changes in its provisions in the future, which will be in effect immediately after being posted on this page. We reserve the right to update or change our Privacy Policy at any time and you should check this Privacy Policy periodically. Your continued use of the Service after we post any modifications to the Privacy Policy on this page will constitute your acknowledgment of the modifications and your consent to abide and be bound by the modified Privacy Policy. If we make any material changes to this Privacy Policy, we will notify you either through the email address you have provided us, or by placing a prominent notice on our website.</p>
                     </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="tabs-content mt-5">
                  <div class="row">
                     <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <div class="informationmain-right-content">
                        <p>We may use your Personal Information to contact you with newsletters, marketing or promotional materials and other information that promotes our products and services.</p>
                     </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="tabs-content mt-5">
                  <div class="row">
                     <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <li>We provide such information to a company controlled by, or under common control with, <?= $GLOBALS['vars']['company_name']?> for any purpose permitted by this Policy.</li>
                        ...
                        <li>We believe it is necessary to share Personal Information to investigate, prevent, or take action regarding illegal activities, suspected fraud, situations involving potential threats to the physical safety of any person, violations of <?= $GLOBALS['vars']['company_name']?>’s Terms of Service, or as otherwise required by law.</li>
                        <li>We transfer Personal Information about you if <?= $GLOBALS['vars']['company_name']?> is, or its assets are, acquired by or merged with another company.</li></ul></p>
                           ...
                           <div class="row">
                              <div class="col-lg-12 col-md-12 col-12">
                                 ...
                                 <p>Use of the <?= $GLOBALS['vars']['company_name']?> text message-based services (the “Service”) is subject to the following Terms of Service. These terms constitute a legal agreement (the “Agreement”). Please read them carefully.<br><br>
                                     ...
                                     <?= $GLOBALS['vars']['company_name']?> will allow several different opportunities, such as a entering a phone number online, to opt-in to SMS services.  The opt-in received will be 'TEXT JOIN to sign up to receive Notifications from BizAgency-USA.'<br><br>
